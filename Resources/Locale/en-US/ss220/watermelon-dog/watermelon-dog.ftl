ent-MobWatermelonDog = watermelon dog
    .desc = Looks like a watermelon with distinct dog features.

ent-WatermelonDogSeeds = packet of watermelon dog seeds
    .desc = { ent-SeedBase.desc }

ghost-role-information-watermelondog-name = Watermelon dog
